...
Add outFile in both areas functionality, remove first transfer, have main method call one test method or the other test method, with each one 
"""
...
class DBN(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None, n_ins=784,
        ...
        for i in range(self.n_layers):
            ...
            # Three cases exist:
            #1. if no transfer has occurred and weights are not initialized. 
            #2. Transfer has occurred, and we are creating first hidden lyaer
            #3. Transfer has occured, and we are creating the second hidden layer
            if not transfer:
    ...
    def pretraining_functions(self, train_set_x, batch_size, k):
        ...
        for rbm in self.rbm_layers:
            ...
            fn = theano.function(
                #inputs=[index, theano.In(learning_rate, value=0.1)], ERROR flag - this line was giving this error: NotImplementedError: 
...
def test_DBN(finetune_lr=0.1, pretraining_epochs=1,
    ...
    outFile = open('postPreTrain.txt','w')
    validation_losses = validate_model()
    this_validation_loss = numpy.mean(validation_losses)
    outFile.write(str(this_validation_loss*100))
    outFile.write('\n')
...
#epoch is originally 500, hidden is 500, learning rate is 0.01
   ...
   #Rahul -  a transfer here will run the code for the second data set first. Not transfer, will run the code in the correct order
    ...
    outFile = open('lettersB4PreTrain.txt','w')
